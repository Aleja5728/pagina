...
class SelectSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        SelectsModel::insert([
            ...
            ['id_question' => 177, 'texto_selects' => 'SI'],
            ['id_question' => 177, 'texto_selects' => 'NO'],
            // Familiar desplazado
            ['id_question' => 178, 'texto_selects' => 'SI'],
            ['id_question' => 178, 'texto_selects' => 'NO'],
            // Se encuentra registrado en el RUPS
            ['id_question' => 180, 'texto_selects' => 'SI'],
            ['id_question' => 180, 'texto_selects' => 'NO'],
            // Mujer con violencia intrafamiliar
            ['id_question' => 181, 'texto_selects' => 'SI'],
            ['id_question' => 181, 'texto_selects' => 'NO'],
            // Familiar deportista
            ['id_question' => 183, 'texto_selects' => 'SI'],
            ['id_question' => 183, 'texto_selects' => 'NO'],
            // Familiar participante en junta de acción comunal
            ['id_question' => 187, 'texto_selects' => 'SI'],
            ['id_question' => 187, 'texto_selects' => 'NO'],
            // Familiar participante caja de compesación
            ['id_question' => 188, 'texto_selects' => 'SI'],
            ['id_question' => 188, 'texto_selects' => 'NO'],
            // Familiar con subsidio de vivienda
            ['id_question' => 189, 'texto_selects' => 'SI'],
            ['id_question' => 189, 'texto_selects' => 'NO'],
            // Por quien recibió subsidio de vivienda
            ['id_question' => 190, 'texto_selects' => 'POR EL MUNICIPIO'],
            ['id_question' => 190, 'texto_selects' => 'POR EL DEPARTAMENTO'],
            ['id_question' => 190, 'texto_selects' => 'POR EL MINISTERIO'],
            // Mejoramiento de vivienda
            ['id_question' => 192, 'texto_selects' => 'SI'],
            ['id_question' => 192, 'texto_selects' => 'NO'],
            // Construcción de vivienda
            ['id_question' => 193, 'texto_selects' => 'SI'],
            ['id_question' => 193, 'texto_selects' => 'NO'],
            // Compra de vivienda
            ['id_question' => 194, 'texto_selects' => 'SI'],
            ['id_question' => 194, 'texto_selects' => 'NO'],
            // Familiar propietario del predio
            ['id_question' => 195, 'texto_selects' => 'SI'],
            ['id_question' => 195, 'texto_selects' => 'NO'],
            ...
            ['id_question' => 201, 'texto_selects' => 'BLOQUE O LADRILLO'],
            ['id_question' => 201, 'texto_selects' => 'CONCRETO'],
            ['id_question' => 201, 'texto_selects' => 'MADERA'],
            ['id_question' => 201, 'texto_selects' => 'TEJAS'],
            ['id_question' => 201, 'texto_selects' => 'OTRO'],
            // Vivienda tiene fisuras
            ['id_question' => 202, 'texto_selects' => 'SI'],
            ['id_question' => 202, 'texto_selects' => 'NO'],
            // Necesidades de su vivienda
            ['id_question' => 203, 'texto_selects' => 'CAMBIO DE CUBIERTAS (TEJAS)'],
            ['id_question' => 203, 'texto_selects' => 'CAMBIO O INSTALACIÓN DE PEINAZOS (SOPORTE DE TEJAS)'],
            ['id_question' => 203, 'texto_selects' => 'CONTRUCCIÓN DE MESÓN'],
            ['id_question' => 203, 'texto_selects' => 'TIENE PISOS DE TIERRA'],
            ['id_question' => 203, 'texto_selects' => 'FALTA PAÑETAR'],
            ['id_question' => 203, 'texto_selects' => 'FALTA PINTAR'],
            ['id_question' => 203, 'texto_selects' => 'FALTA ENCHAPAR PISOS DE LA CASA'],
            ['id_question' => 203, 'texto_selects' => 'FALTA ENCHAPAR BAÑO'],
            ['id_question' => 203, 'texto_selects' => 'FALTA ENCHAPAR COCINA'],
            ['id_question' => 203, 'texto_selects' => 'FALTAN APARATOS SANITARIOS (SANITARIO, LAVAMANOS Y/O DUCHA)'],
            // Familiar con otra propiedad
            ['id_question' => 205, 'texto_selects' => 'SI'],
            ['id_question' => 205, 'texto_selects' => 'NO'],
        ...
        SelectsModel::insert([
            ...
            ['id_question' => 209, 'texto_selects' => 'PERSONA NATURAL'],
            ['id_question' => 209, 'texto_selects' => 'PERSONA JURÍDICA'],
            // Tipo de sociedad
            ['id_question' => 210, 'texto_selects' => 'ENTIDAD SIN ÁNIMO DE LUCRO - ESAL'],
            ['id_question' => 210, 'texto_selects' => 'LIMITADA - LTDA'],
            ['id_question' => 210, 'texto_selects' => 'SOCIEDAD ANÓMICA S.A.'],
            ['id_question' => 210, 'texto_selects' => 'SOCIEDAD COLECTIVA'],
            ['id_question' => 210, 'texto_selects' => 'SOCIEDAD EN COMANDITA'],
            ['id_question' => 210, 'texto_selects' => 'SOCIEDAD EN COMANDITA POR ACCIONES'],
            ['id_question' => 210, 'texto_selects' => 'SOCIEDAD EN COMANDITA SIMPLE'],
            ['id_question' => 210, 'texto_selects' => 'SOCIEDAD POR ACCIONES SIMPLIFICADAS (SAS)'],
            ['id_question' => 210, 'texto_selects' => 'UDEC'],
            ...
            ['id_question' => 218, 'texto_selects' => 'MENOS DE 1 AÑO'],
            ['id_question' => 218, 'texto_selects' => 'DE 1 A 2 AÑOS'],
            ['id_question' => 218, 'texto_selects' => 'DE 2 A 3 AÑOS'],
            ['id_question' => 218, 'texto_selects' => 'DE 3 A 5 AÑOS'],
            ['id_question' => 218, 'texto_selects' => 'DE 5 A 10 AÑOS'],
            ['id_question' => 218, 'texto_selects' => 'MÁS DE 10 AÑOS'],
            // A que sector pertenece la empresa
            ['id_question' => 219, 'texto_selects' => 'PRIMARIO O AGROPECUARIO - OBTIENE PRODUCTOS DIRECTAMENTE DE LA NATURALEZA SIN TRANSFORMAR'],
            ['id_question' => 219, 'texto_selects' => 'SECUNDARIO O INDUSTRIAL - TRANSFORMA MATERIAS PRIMAS EN PRODUCTOS TERMINADOS O SEMIELABORADOS'],
            ['id_question' => 219, 'texto_selects' => 'TERCIARIO O DE SERVICIOS - NO PRODUCE BIENES; SE ENFOCA EN LOS SERVICIOS'],
            // Primario
            ['id_question' => 220, 'texto_selects' => 'CULTIVO DE FRUTAS'],
            ['id_question' => 220, 'texto_selects' => 'CULTIVO DE CAFÉ'],
            ['id_question' => 220, 'texto_selects' => 'CULTIVO DE HORTALIZAS'],
            ['id_question' => 220, 'texto_selects' => 'CULTIVO DE PANCOGER'],
            ['id_question' => 220, 'texto_selects' => 'CULTIVO DE PLÁTANO'],
            ['id_question' => 220, 'texto_selects' => 'AVICULTORES'],
            ['id_question' => 220, 'texto_selects' => 'CULTIVO DE AGUACATE'],
            ['id_question' => 220, 'texto_selects' => 'OTRAS PRODUCCIONES PECUARIAS'],
            ['id_question' => 220, 'texto_selects' => 'OTRAS ACTIVIDADES DEL SECTOR PRIMARIO'],
            // Secundario
            ['id_question' => 221, 'texto_selects' => 'PRODUCCIÓN DE LÁCTEOS'],
            ['id_question' => 221, 'texto_selects' => 'PRODUCCIÓN DE ACEITES'],
            ['id_question' => 221, 'texto_selects' => 'FABRICACIÓN DE ARTESANÍAS O MANUALIDADES'],
            ['id_question' => 221, 'texto_selects' => 'DISEÑO DE PRENDAS DE VESTIR'],
            ['id_question' => 221, 'texto_selects' => 'GASTRONOMÍA - ALIMENTOS NO EMPACADOS'],
            ['id_question' => 221, 'texto_selects' => 'OTROS ALIMENTOS EMPACADOS'],
            ['id_question' => 221, 'texto_selects' => 'FABRICACIÓN DE MUEBLES'],
            ['id_question' => 221, 'texto_selects' => 'FABRICACIÓN DEL PRODUCTO PARA EL CUIDADO'],
            ['id_question' => 221, 'texto_selects' => 'PAISAJISMO - ORNATO'],
            ['id_question' => 221, 'texto_selects' => 'PRODUCCIÓN DE LICORES'],
            ['id_question' => 221, 'texto_selects' => 'OTROS PRODUCTOS DE AGROINDUSTRIA'],
            ['id_question' => 221, 'texto_selects' => 'OTROS PRODUCTOS DEL SECTOR SECUNDARIO'],
            // Terciario
            ['id_question' => 222, 'texto_selects' => 'SERVICIOS INMOBILIARIOS'],
            ['id_question' => 222, 'texto_selects' => 'CONTRUCCIÓN, PINTURA Y TERMINADOS'],
            ['id_question' => 222, 'texto_selects' => 'SERVICIOS DE SALUD'],
            ['id_question' => 222, 'texto_selects' => 'SERVICIOS DE BELLEZA Y EL CUIDADO'],
            ['id_question' => 222, 'texto_selects' => 'COMUNICACIONES'],
            ['id_question' => 222, 'texto_selects' => 'SERVICIOS DE RECREACIÓN'],
            ['id_question' => 222, 'texto_selects' => 'ORGANIZACIÓN DE EVENTOS'],
            ['id_question' => 222, 'texto_selects' => 'SERVICIOS EDUCATIVOS'],
            ['id_question' => 222, 'texto_selects' => 'SEGURIDAD PRIVADA'],
            ['id_question' => 222, 'texto_selects' => 'SERVICIOS TURÍSTICOS'],
            ['id_question' => 222, 'texto_selects' => 'SERVICIOS DE MANTENIMIENTO'],
            ['id_question' => 222, 'texto_selects' => 'SERVICIOS DE ASEO'],
            ['id_question' => 222, 'texto_selects' => 'SERVICIOS DE TRANSPORTE'],
            ['id_question' => 222, 'texto_selects' => 'OTRAS ACTIVIDADES DEL SECTOR TERCIARIO'],
            // Su empresa cuenta con maquinaria
            ['id_question' => 224, 'texto_selects' => 'SI'],
            ['id_question' => 224, 'texto_selects' => 'NO'],
            // Cuantos empleos directos genera
            ['id_question' => 226, 'texto_selects' => 'NINGUNO'],
            ['id_question' => 226, 'texto_selects' => '1'],
            ['id_question' => 226, 'texto_selects' => 'DE 2 A 3'],
            ['id_question' => 226, 'texto_selects' => 'DE 4 A 6'],
            ['id_question' => 226, 'texto_selects' => 'DE 7 A 10'],
            ['id_question' => 226, 'texto_selects' => 'MÁS DE 10'],
            // Los empleos que genera son
            ['id_question' => 227, 'texto_selects' => 'INFORMALES'],
            ['id_question' => 227, 'texto_selects' => 'FORMALES'],
            // El canal de distribucion de su empresa es
            ['id_question' => 229, 'texto_selects' => 'DIRECTO'],
            ['id_question' => 229, 'texto_selects' => 'CON 1 INTERMEDIARIO'],
            ['id_question' => 229, 'texto_selects' => 'CON 2 INTERMEDIARIOS'],
            ['id_question' => 229, 'texto_selects' => 'CON 3 O MÁS INTERMEDIARIO'],
            // Que medios publicitarios usa
            ['id_question' => 230, 'texto_selects' => 'PUBLICIDAD IMPRESA'],
            ['id_question' => 230, 'texto_selects' => 'PUBLICIDAD EN LÍNEA (INTERNET)'],
            ['id_question' => 230, 'texto_selects' => 'PUBLICIDAD EXTERIOR (AVISOS)'],
            ['id_question' => 230, 'texto_selects' => 'RADIO'],
            ['id_question' => 230, 'texto_selects' => 'VOZ A VOZ'],
            ['id_question' => 230, 'texto_selects' => 'TELEVISIÓN'],
            ['id_question' => 230, 'texto_selects' => 'NINGUNO'],
            // Que herramientas publicitarias usa
            ['id_question' => 231, 'texto_selects' => 'TARJETAS DE PRESENTACIÓN'],
            ['id_question' => 231, 'texto_selects' => 'SEPARADOR DE LIBROS'],
            ['id_question' => 231, 'texto_selects' => 'VOLANTES'],
            ['id_question' => 231, 'texto_selects' => 'AFICHES'],
            ['id_question' => 231, 'texto_selects' => 'FICHAS GRÁFICAS DIGITALES'],
            ['id_question' => 231, 'texto_selects' => 'VIDEOS'],
            ['id_question' => 231, 'texto_selects' => 'NINGUNO'],
            // Su empresa cuenta con registro mercantil
            ['id_question' => 232, 'texto_selects' => 'SI'],
            ['id_question' => 232, 'texto_selects' => 'NO'],
            // Su empresa cuenta con RUT
            ['id_question' => 234, 'texto_selects' => 'SI'],
            ['id_question' => 234, 'texto_selects' => 'NO'],
            // Se encuentra al día con el pago de impuesto
            ['id_question' => 235, 'texto_selects' => 'SI'],
            ['id_question' => 235, 'texto_selects' => 'NO'],
            // Cual es su promedio de ventas mensuales
            ['id_question' => 236, 'texto_selects' => 'MENOS DE 1 SMLMV'],
            ['id_question' => 236, 'texto_selects' => 'ENTRE 1 Y 2 SMLMV'],
            ['id_question' => 236, 'texto_selects' => 'ENTRE 2 Y 3 SMLMV'],
            ['id_question' => 236, 'texto_selects' => 'ENTRE 3 Y 6 SMLMV'],
            ['id_question' => 236, 'texto_selects' => 'ENTRE 6 Y 10 SMLMV'],
            ['id_question' => 236, 'texto_selects' => 'MÁS DE 10 SMLMV'],
            // Ha recibido apoyo de entidades
            ['id_question' => 237, 'texto_selects' => 'SI'],
            ['id_question' => 237, 'texto_selects' => 'NO'],
            // Entidades de las cuales ha recibido apoyo
            ['id_question' => 238, 'texto_selects' => 'SECRETARÍA DE DESARROLLO ECONÓMICO Y COMPETITIVIDAD'],
            ['id_question' => 238, 'texto_selects' => 'OTRA DEPENDENCIA DE LA ALCALDÍA MUNICIPAL DE FUSAGASUGÁ'],
            ['id_question' => 238, 'texto_selects' => 'CÁMARA DE COMERCIO DE BOGOTÁ'],
            ['id_question' => 238, 'texto_selects' => 'GOBERNACIÓN DE CUNDINAMARCA'],
            ['id_question' => 238, 'texto_selects' => 'ENTIDAD FINANCIERA'],
            ['id_question' => 238, 'texto_selects' => 'SENA'],
            ['id_question' => 238, 'texto_selects' => 'OTRO'],
        ...
        SelectsModel::insert([
            ...
            ['id_question' => 245, 'texto_selects' => 'JEFE DE HOGAR'],
            ['id_question' => 245, 'texto_selects' => 'ESPOSO(A)'],
            ['id_question' => 245, 'texto_selects' => 'HIJO(A)'],
            ['id_question' => 245, 'texto_selects' => 'PRIMO(A)'],
            ['id_question' => 245, 'texto_selects' => 'TIO(A)'],
            ['id_question' => 245, 'texto_selects' => 'NIETO(A)'],
            ['id_question' => 245, 'texto_selects' => 'SUEGRO(A)'],
            ['id_question' => 245, 'texto_selects' => 'YERNO/NUERA'],
            // Ubicación del inmueble
            ['id_question' => 246, 'texto_selects' => 'URBANO'],
            ['id_question' => 246, 'texto_selects' => 'RURAL'],
            // Propiedad del inmueble
            ['id_question' => 247, 'texto_selects' => 'PROPIA'],
            ['id_question' => 247, 'texto_selects' => 'ARRIENDO'],
            // Estado del inmueble
            ['id_question' => 248, 'texto_selects' => 'HABITABLE'],
            ['id_question' => 248, 'texto_selects' => 'NO HABITABLE'],
            ['id_question' => 248, 'texto_selects' => 'DESTRUIDA'],
            //AHE. ALIM
            ...
            //SUB. ARRIENDO
            ['id_question' => 252, 'texto_selects' => 'SI'],
            ['id_question' => 252, 'texto_selects' => 'NO'],
            //ANIMALES DOMESTICOS
            ['id_question' => 253, 'texto_selects' => 'SI'],
            ['id_question' => 253, 'texto_selects' => 'NO'],
        ]);

        // Preguntas de turismo
        SelectsModel::insert([
            // Tipo de ciudadano
            ['id_question' => 256, 'texto_selects' => 'PRESTADOR DE SERVICIOS TURISTICOS'],
            ['id_question' => 256, 'texto_selects' => 'TURISTA'],
            // Registro nacional de turismo activo
            ['id_question' => 257, 'texto_selects' => 'SI'],
            ['id_question' => 257, 'texto_selects' => 'NO'],
            // Tipo de servicio turistico
            ['id_question' => 258, 'texto_selects' => 'FINCA TURISTICA (ALOJAMIENTO RURAL)'],
            ['id_question' => 258, 'texto_selects' => 'ESTABLECIMIENTO DE ALOJAMIENTO Y HOSPEDAJE (HOTEL)'],
            ['id_question' => 258, 'texto_selects' => 'OTRO TIPO DE VIVIENDA TURÍSTICA'],
            ['id_question' => 258, 'texto_selects' => 'CENTRO VACACIONAL'],
            ['id_question' => 258, 'texto_selects' => 'GUÍA DE TURISMO'],
            ['id_question' => 258, 'texto_selects' => 'AGENCIA DE VIAJES Y TURISMO'],
            ['id_question' => 258, 'texto_selects' => 'OTRO'],
            // Motivo de viaje
            ['id_question' => 265, 'texto_selects' => 'NEGOCIOS'],
            ['id_question' => 265, 'texto_selects' => 'TRABAJO'],
            ['id_question' => 265, 'texto_selects' => 'RECREACIÓN'],
            ['id_question' => 265, 'texto_selects' => 'SALUD'],
            ['id_question' => 265, 'texto_selects' => 'OTRO'],
            // En donde se esta hospedando
            ['id_question' => 267, 'texto_selects' => 'FINCA TURISTICA (ALOJAMIENTO RURAL)'],
            ['id_question' => 267, 'texto_selects' => 'ESTABLECIMIENTO DE ALOJAMIENTO Y HOSPEDAJE (HOTEL)'],
            ['id_question' => 267, 'texto_selects' => 'OTRO TIPO DE VIVIENDA TURÍSTICA (AIR BNB, HOSTEL, ECT)'],
            ['id_question' => 267, 'texto_selects' => 'CENTRO VACACIONAL'],
            ['id_question' => 267, 'texto_selects' => 'CASA DE UN FAMILIAR O AMIGO'],
            ['id_question' => 267, 'texto_selects' => 'OTRO'],
        ]);
    }
}
