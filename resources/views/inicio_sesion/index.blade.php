...
@section('seccion')
    <div class="seccion_imagen w-[50%] absolute start-0">
    ...
    <div class="seccion_formulario w-[50%]  absolute end-0">
        <form action="{{ route('validacion-sesion') }}" method="post"
            class="w-[50%] h-[50%] m-auto mt-[20%] p-5 flex flex-col">
            @csrf
            ...
            <a href="{{ url('reestablecimiento-clave') }}"
