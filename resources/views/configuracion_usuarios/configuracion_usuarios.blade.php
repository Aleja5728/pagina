...
@section('seccion')
    ...
    <div class="static flex w-full h-12 mt-10">
        ...
        <div>
            <a
                class="bg-[#3268C9] hover:bg-[#5381D4] text-[#fff] font-montserrat text-xs rounded-xl w-32 p-2.5 cursor-pointer boton_modal1">
                Agregar usuario
            </a>
        </div>
        <!-- Buscar usuario -->
        <form action="configuracion-usuarios" method="GET">
            <div class="absolute right-12 barra_busqueda">
                <div>
                    <div>
                        <input type="text" name="buscar_usuario" id="buscar_usuario" autocomplete="off" value="{{$buscar_usuario}}"
    ...
    <x-formulario_creacion_usuarios></x-formulario_creacion_usuarios>
